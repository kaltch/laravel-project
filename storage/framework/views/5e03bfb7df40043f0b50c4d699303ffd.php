...
<div class='container'>
    <div class='row'>
        ...
        <div class='col-md-6' style='height: 90vh;'>
            <div class='img-fluid bg-cover bg-position-center rounded-bottom-left-xxl' style='background-image: url("/images/home-01.jpg");'>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('Front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/Front/home.blade.php ENDPATH**/ ?>